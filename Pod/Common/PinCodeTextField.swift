...
@IBDesignable public class PinCodeTextField: UIView {
    ...
    @IBInspectable public var underlineHeight: CGFloat = 0.5
    ...
    private func updateLabels() {
        ...
        for label in labels {
            ...
            label.text = currentCharacter.map {
                String($0)
            }
            label.font = font
    ...
    private func layoutCharactersAndPlaceholders() {
        ...
        underlines.forEach {
            ...
            currentUnderlineX += underlineWidth + (bounds.width - underlineWidth * CGFloat(characterLimit)) / CGFloat(marginsCount);
        }
        ...
        labels.forEach {
            ...
            currentLabelCenterX += underlineWidth + (bounds.width - underlineWidth * CGFloat(characterLimit)) / CGFloat(marginsCount);
        }
